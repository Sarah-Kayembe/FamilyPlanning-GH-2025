...
class AppointmentServiceTest {
    ...
    private Patient createSamplePatient(String username) {
        return new Patient(
                username, "Test", "Patient", "hashedpass", "None",
                "2025-01-01", "NHIS123", "CARD123", "Single", "Female",
                "123 Street, Community A", "Injection", true, 28, 2,
                new HashMap<>()
        );
    }
    ...
    public void testCreateAppointmentSuccess() {
        ...
        Patient patient = createSamplePatient("patient01");
    ...
    public void testCreateAppointmentUnauthorizedThrows() {
        ...
        // Sample patient
        Patient patient = createSamplePatient("patient02");
    ...
    public void testUpdateAppointmentSuccess() {
        ...
        Patient patient = createSamplePatient("patient03");
    ...
    public void testCancelAppointmentSuccess() {
        ...
        Patient patient = createSamplePatient("patient04");
    ...
    public void testGetAlertsReturnsUpcoming() {
        ...
        Patient patient = createSamplePatient("patient07");
